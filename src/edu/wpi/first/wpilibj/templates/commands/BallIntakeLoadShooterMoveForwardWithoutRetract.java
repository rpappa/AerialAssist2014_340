 ...
 * @author Tech
 */
public class BallIntakeLoadShooterMoveForwardWithoutRetract extends CommandBase {
    
    private final int DISTANCE_TO_WALL = 20;
    
    public BallIntakeLoadShooterMoveForwardWithoutRetract(double driveSpeed) {
