 ...
 * @author grr340
 */
public class DoVisionProcessing extends CommandBase {
    //111, 143, 231, 255, 239, 255
    int hueLow = 74;
    int hueHigh = 106;
    int saturationLow = 16;
    int saturationHigh = 64;
    int valueLow = 131;
    int valueHigh = 163;
    
    public DoVisionProcessing() {
...
//        System.out.println("Activating vision processing.");
    ...
    protected void execute() {
        //System.out.println("DoVisionProcessing executed");
        try {
            image = visionProcessing.captureImage();
            //System.out.println("width" + image.getWidth());
            //System.out.println("height " + image.getHeight());
            hueLow = (int)SmartDashboard.getNumber("Hue low", 74);
            hueHigh = (int)SmartDashboard.getNumber("Hue high", 106);
            saturationLow = (int)SmartDashboard.getNumber("Saturation low", 16);
            saturationHigh = (int)SmartDashboard.getNumber("Saturation high", 64);
            valueLow = (int)SmartDashboard.getNumber("Value low", 131);
            valueHigh = (int)SmartDashboard.getNumber("Value high", 163);
            //System.out.println("HueL:" + hueLow + " HueH:" + hueHigh + " SaturationL:" + saturationLow + " SaturationH:" + saturationHigh + " ValueL:" + valueLow + " ValueH:" + valueHigh);
            thresholdImage = image.thresholdHSV(hueLow, hueHigh, saturationLow, saturationHigh, valueLow, valueHigh);
            //111, 143, 231, 255, 239, 255
            ...
            if (filteredImage.getNumberParticles() > 0) {
                ...
                for (int i = 0; i < verticalTargetCount; i++) {
                    ...
                    for (int j = 0; j < horizontalTargetCount; j++) {
                        ...
                        //System.out.println("Horizontal Width " + horizWidth);
                       ...
                       // System.out.println("Vertical Width " + vertWidth);
                        ...
                        //System.out.println("Horizontal Height " + horizHeight);
...
//                        System.out.println("Distance: " + distance);
        ...
        isHotOrNot = hotOrNot(target);
        SmartDashboard.putBoolean("IsHotOrNot", isHotOrNot);
//        System.out.println("[DoVisionProcesssing]:" + isHotOrNot);
    }

    // Make this return true when this Command no longer needs to run execute()
    protected boolean isFinished() {
//        if(hotOrNot(target)==true) {
...
//        }
    ...
    boolean hotOrNot(TargetReport target) {
        ...
        //System.out.println("Tape width score " + target.tapeWidthScore);
        isHot &= target.verticalScore >= VERTICAL_SCORE_LIMIT;
        //System.out.println("Tape vertical score " + target.verticalScore);
