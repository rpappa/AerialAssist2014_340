 ...
 * @author Tech
 */
public class AutoTwoBallMobilitySlow extends CommandGroup {
    
    public AutoTwoBallMobilitySlow() {
        /////////////
        //  shoot  //
        /////////////
        //Step 1
        ...
        //Step 2
        addSequential(new ShootPrepareBall(50),1.0);
        addSequential(new ShootNow());
        //Step 3
//        addSequential(new ManualBallIntakeGoToMid(), 0.5);
        addSequential(new ShooterPullBackWithEncoder());
        ...
        //addSequential(new BallIntakeHoldBall());
        //Step 2
        addSequential(new ShootPrepareBall(50));
        addSequential(new ShootNow());
        //Step 3
//        addSequential(new ManualBallIntakeGoToMid(), 0.5);
        addParallel(new ShooterPullBackWithEncoder());
        ...
        // arm.
        addSequential(new DriveFwd(.8), 5);
    }
}
